...
setup(
    name="pws-api-wrapper",
    # Versions should comply with PEP440
    version=get_version("src/pws_api_wrapper/_version.py"),
    description="Python wrapper for pentest.ws API",
    long_description=readme(),
    long_description_content_type="text/markdown",
    url="https://github.com/bjb28/psw-api-wrapper",
    # Additional URLs for this project per
    # https://packaging.python.org/guides/distributing-packages-using-setuptools/#project-urls
    project_urls={
        "Source": "https://github.com/bjb28/pws-api-wrapper",
        "Tracker": "https://github.com/bjb28/pws-api-wrapper/issues",
    },
    # Author details
    author="Bryce B",
